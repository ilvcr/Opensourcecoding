/*************************************************************************
> File Name: gather.hpp
> Author: yoghourt->ilvcr 
> Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
> Created Time: 2018年08月20日 星期一 11时21分42秒
> Description: 
...
namespace boost{ 
    namespace algorithm{
        ...
        */
        ...
        template<typename BidirectionalIterator,  // Iter models BidirectionalIterator
        ...
        std::pair<BidirectionalIterator, BidirectionalIterator> gather 
            ...
            return std::make_pair(std::stable_partition(first, pivot, !boost::bind<bool>(pred, _1)),
        ...
        */
        ...
        template<typename BidirectionalRange, typename Pred>                  // Pred models UnaryPredicate
        std::pair<typename boost::range_iterator<const BidirectionalRange>::type,
                  typename boost::range_iterator<const BidirectionalRange>::type>
        gather(const BidirectionalRange &range, typename boost::range_iterator<const BidirectionalRange>::type pivot,
                                                    Pred pred){
