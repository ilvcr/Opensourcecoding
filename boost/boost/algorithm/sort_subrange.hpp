/*************************************************************************
> File Name: sort_subrange.hpp
> Author: yoghourt->ilvcr 
> Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
> Created Time: 2018年08月20日 星期一 15时04分39秒
> Description: 
    ...
    namespace algorithm{
        ...
        void sort_subrange(Iterator first, Iterator last, Iterator sub_first, 
            ...
            if(sub_first == sub_last){
                ...
                return;      // the empty sub-range is already sorted.
            }
            ...
            std::partial_sort(sub.first, sub_last, last, p);
        }
        ...
        template<typename Iterator, typename Pred>
        void partition_subrange(Iterator first, Iterator last, Iterator sub_first, 
                                                         Iterator sub_last, Pred p){
