/*************************************************************************
> File Name: partition_copy.hpp
> Author: yoghourt->ilvcr 
> Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
> Created Time: 2018年08月01日 星期三 15时47分33秒
> Description: 
...
namespace boost{
    namespace algorithm{
        ...
        partition_copy(InputIterator first, InputIterator last, OutputIterator1 out_true,    \
        ...
        std::pair<OutputIterator1, OutputIterator2>
        partition_copy(const Range& r, OutputIterator2 out_ture, OutputIterator2 out_false, UnaryPredicate p){

            return boost::algorithm::partition_copy(boost::begin(r), boost::end(r), out_true, out_false, p);
        }
    }
