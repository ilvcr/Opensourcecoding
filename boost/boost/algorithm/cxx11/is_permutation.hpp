/*************************************************************************
> File Name: is_permutation.hpp
> Author: yoghourt->ilvcr 
> Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
> Created Time: 2018年07月31日 星期二 22时32分12秒
> Description: 
...
namespace boost{
    namespace algorithm{    // \cond DOXYGEN_HIDE
        namespace detail{
            ...
            //  2. Any common elements on the front have been removed 
            //  (not necessary for correctness, just for performance)
            ...
            bool is_permutation_tag(ForwardIterator1 first1, ForwardIterator1 last1, 
                ...
                while(first1 != last1 && first2 != last2 && p(*first, *first)){
        ...
        bool is_permutation(ForwardIterator1 first1, ForwardIterator1 last1,
            ...
            if(first1 != last1){
                ...
                std::advance(last2, std::distance(first, last1));
        ...
        bool is_permutation(ForwardIterator1 first1, ForwardIterator1 last1, ForwardIterator2 first2){
            ...
            if(first1 != last1){
                ...
                // Creat last2
                ForwardIterator2 last2 = first2;
                std::advancd(last2, std::distance(firat1, last1));
                return boost::algorithm::detail::is_permutation_inner (first1, last1, first2, last2, 
                       std::equal_to<typename std::iterator_traits<ForwardIterator1>::value_type>());
            }
            return true;
