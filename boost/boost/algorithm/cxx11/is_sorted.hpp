/*************************************************************************
> File Name: is_sorted.hpp
> Author: yoghourt->ilvcr 
> Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
> Created Time: 2018年07月31日 星期二 23时10分19秒
> Description: 
    ...
    namespace algorithm{
        ...
        ForwardIterator is_sorted_until(ForwardIterator first, ForwardIterator last, Pred p){
            ...
            if(first == last){
                ...
                return last;  // the empty sequence is ordered
            }
        ...
        ForwardIterator is_sorted_until(ForwardIterator first, ForwardIterator last){
            ...
            typedef typename std::iterator_traits<ForwardIterator>::value_type valu_type;
        ...
        typename boost::lazy_disable_if_c<boost::is_same<R, Pred>::value, typename boost::range_iterator<const R> >     \
        ...
        // \param p     A binary predicate that returns true if two elements are ordered.
        template<typename R, typename Pred>
        typename boost::lazy_disable_if_c<boost::is_same<R, Pred>::value, boost::mpl::identity<bool> >::type is_sorted (const R &range, Pred p){
        ...
        bool is_increasing(ForwardIterator first, ForwardIterator last){
            ...
            typedef typename std::iterator_trains<ForwardIterator>::value_type value_type;
