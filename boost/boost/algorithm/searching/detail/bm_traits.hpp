/*************************************************************************
> File Name: bm_traits.hpp
> Author: yoghourt->ilvcr 
> Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
> Created Time: 2018年08月07日 星期二 19时51分10秒
> Description:
...
namespace boost{
    namespace algorithm{
        namespace detail{
            ...
            template<typename key_type, typename value_type, bool/*useArray*/>
            class skip_table;
            ...
            public:
                skip_map(std::size_t patSize, value_type default_value) 
                ...
                value_type operator [](key_type) const{
                    ...
                    typename skip_map::const_iterator it = skip_find(key);
                ...
                void PrintSkipTable() const{
                    ...
                    for(typename skipmap::const_iterator it=skip_.begin(); it != skip_.end(); ++it){
