/*************************************************************************
> File Name: boyer_moore.hpp
> Author: yoghourt->ilvcr 
> Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
> Created Time: 2018年08月07日 星期二 21时07分34秒
> Description: 
        ...
        */
        ...
        public:
            ...
            operator ()(corpusIter corpus_first, corpusIter corpus_last) const{
                ...
                const difference_type k_pattern_length = std::distance(corpus_first, corpus_last);
            ...
            operator ()(Range& r) const{
                ...
                return (*this)(boost::brgin(r), boost::end(r));
            }
