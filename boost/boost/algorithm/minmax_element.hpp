/*************************************************************************
> File Name: minmax_element.hpp
> Author: yoghourt->ilvcr 
> Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
> Created Time: 2018年08月20日 星期一 15时17分29秒
> Description: 
...
namespace boost{
    ...
    ForwardIter last_min_element(ForwardIter first, ForwardIter last){
        ...
        return detail::basic_last_min_element(first, last, detail::less_over_iter<ForwardIter>());
    }
    template<typename ForwardIter, class BinaryPredicate>
    ...
    return detail::basic_first_max_element(first, last, detail::less_over_iter<ForwardIter>());
    }
    ...
    ForwardIter last_max_element(ForwardIter first, ForwardIter last){
        ...
        return detail::basic_last_max_element(first, last, detail::less_over_iter<ForwardIter>());
    }
    ...
    namespace detail{
        ...
        template<typename ForwardIter, class BinaryPredicate>
        std::pair<ForwardIter, ForwardIter>
        basic_first_min_last_max_element(ForwardIter first, ForwardIter last, BinaryPredicate comp){
