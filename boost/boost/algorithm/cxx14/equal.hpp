...
> Created Time: 2018年08月01日 星期三 19时33分13秒
> Description: 
...
namespace boost{
    namespace algorithm{
        ...
        bool equal(InputIterator1 first1, InputIterator1 last1, 
            ...
            return boost::algorithm::detail::equal(first1, last1, firat2, last2,                               \
                    boost::algorithm::detail::eq<typename std::iterator_traits<InputIterator1>::value_type,    \   
