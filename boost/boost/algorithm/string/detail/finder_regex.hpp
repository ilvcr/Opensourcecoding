/*************************************************************************
> File Name: finder_regex.hpp
> Author: yoghourt->ilvcr 
> Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
> Created Time: 2018年08月13日 星期一 23时04分09秒
> Description: 
...
//  regex find functor -----------------------------------------------//
            ...
            struct regex_search_result : public iterator_range<IteratorT>{
                ...
                regex_search_result(const match_results_type& MatchResults) : base_type
                        (MatchResults[0].first, MatchResults[0].second), m_MatchResults(MatchResults){
                }

                // Construction of empty match. End iterator has to be specified
                regex_search_result(IteratorT End) : base_type(End, End){
                }

                regex_search_result(const regex_search_result& Other) : base_type
                        (Other.begin(), Other.end()), m_MatchResult(Other.m_MatchResults){
                }
                ...
                const match_results_type& match_result() const{
            ...
            struct find_regexF{
                ...
                regex_search_result<ForwardIteratorT> operator()(ForwardIteratorT Begin,
                    ...
                    match_result<input_iterator_type> result;
                    // search for a match
