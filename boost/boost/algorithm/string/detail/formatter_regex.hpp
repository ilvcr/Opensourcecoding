/*************************************************************************
> File Name: formatter_regex.hpp
> Author: yoghourt->ilvcr 
> Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
> Created Time: 2018年08月14日 星期二 20时42分15秒
> Description: 
...
//  regex format functor -----------------------------------------//
            ...
            public:
                ...
                regex_formatF(const StringT& Fmt, match_flag_type Flags=format_default) 
                     : m_Fmt(Fmt), m_Flag(Flags){
                }

                template<typename InputIteratorT>
                result_type operator()(const regex_search_result<InputIteratorT>& Replace) const{
                    ...
                    if(Replace.empty()){
                        ...
                        return Replace.match_result().format(m_Fmt, m_Flags);
                    }
                }
            private:
                const StringT& m_Fmt;
