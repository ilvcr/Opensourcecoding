/*************************************************************************
> File Name: trim_all.hpp
> Author: yoghourt->ilvcr 
> Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
> Created Time: 2018年08月19日 星期日 21时53分06秒
> Description: 
...
// multi line trim  ----------------------------------------------- //
        ...
        inline SequenceT trim_all_copy_if(const SequenceT& Input, PredicateT IsSpace){
            ...
            return ::boost::find_format_all_copy(::boost::trim_copy_if(Input, IsSpace),
        ...
        inline void trim_all_if(SequenceT& INput, PredicateT IsSpace){
            ...
            ::boost::find_format_all(Input, ::boost::token_finder(IsSpace, ::boost::token_compress_on),
                                            ::boost::dissect_formatter(::boost::head_finder(1)));
        }
