/*************************************************************************
> File Name: regex_find_format.hpp
> Author: yoghourt->ilvcr 
> Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
> Created Time: 2018年08月18日 星期六 21时52分53秒
> Description: 
...
//  regex_finder  -----------------------------------------------//
        ...
        inline detail::finder_regexF<basic_regex<CharT, RegexTraitsT> > regex_finder(
                                            const basic_regex<CharT, RegexTraitsT>& Rx, 
                                            match_flag_type MatchFlags=match_default{

            return detail::find_regexF<basic_regex<CharT, RegexTraitsT> >(Rx, MatchFlags);
        }
...
//  regex_formater  ---------------------------------------------//
        ...
        inline detail::regex_formatF< std::basic_string<CharT, TraitsT, AllocT > > 
                    regex_formatter(const std::basic_string<CharT, TraitsT, AllocT>& Format,
                    match_flag_type Flags=format_default){

            return detail::regex_formatF<std::regex_formatF< std::basic_string<CharT, 
                                    TraitsT, AllocT> >(Format, Flags);
        }
