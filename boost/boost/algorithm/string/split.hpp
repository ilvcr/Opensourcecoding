...
> Created Time: 2018年08月19日 星期日 21时40分17秒
> Description: 
...
//  find_all  ------------------------------------------------------------//
        ...
        inline SequenceSequenceT& find_all(SequenceSequenceT& Result, Range1T& Input, 
                                                                      const Range2T& Search){

            return ::boost::algorithm::iter_find(Result, Input, ::boost::algorithm::first_finder(Search));
        }
         ...
         */
        template<typename SequenceSequenceT, typename Range1T, typename Range2T>
        inline SequenceSequenceT& ifind_all(SequenceSequenceT& Result, Range1T& Input, const Range2T& Search,
                                            const std::locale& Loc=std::locale()){

            return ::boost::algorithm::iter_locale(Result, Input, 
...
//  tokenize  -------------------------------------------------------------//
        ...
        inline SequenceSequenceT& split(SequenceSequenceT& Result, RangeT& Input, PredicateT Pred,
                                        token_compress_mode_type eCompress=token_compress_off){

            return ::boost::algorithm::iter_split(Result, Input, 
