/*************************************************************************
> File Name: droppable_accumulator.hpp
> Author: yoghourt->ilvcr 
> Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
> Created Time: 2018年07月28日 星期六 22时18分35秒
> Description: 
    ...
    namespace accumulators {
        ...
        namespace detail{
            ...
            struct add_ref_visitor{
                ...
                explicit add_ref_visitor(Args const& args) : args_(args){
                }
            ...
            struct drop_visitor{
                ...
                explicit drop_visitor(Args const& args) : args_(args){
                }
        ...
        template<typename accumulator>
        struct droppable_accumulator_base : Accumulator{
        ...
        template<typename Accumulator>
        struct droppable_accumulator : droppable_accumulator_base<Accumulator>{
        ...
        // with_cached_result
        template<typename Accumulator>
        struct with_cached_result : Accumulator{

            typedef typename Accumulator::result_type result_type;

            template<typename Args>
            with_cached_result(Args const& args) : Accumulator(args), cache(){
            }

            with_cached_result(with_cached_result const& that) : Accumulator(*static_cast<Accumulator const*>(&that), cache()){
        ...
        private:
            ...
            result_type const& get() const{
                ...
                return *static_cast<result_type consot*>(this->cache.address());
            }
        ...
        namespace tag{
            ...
            // droppable
            template<typename Feature>
            struct droppable : as_droppable<Feature>::type{
        ...
        template<typename Feature>
        struct feature_of<tag::droppable<Feature> > : feature_of<Feature>{
        };
