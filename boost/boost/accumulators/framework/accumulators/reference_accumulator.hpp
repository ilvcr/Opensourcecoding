/*************************************************************************
> File Name: reference_accumulator.hpp
> Author: yoghourt->ilvcr 
> Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
> Created Time: 2018年07月29日 星期日 09时19分02秒
> Description: 
...
namespace boost{ 
    namespace accumulators{
        namespace impl{
            ...
            struct reference_accumulator_impl : accumulator_base{
                
                typedef Referent& result_type;
                
                template<typename Args>
                reference_accumulator_impl(Args const& args) : ref(args[parameter::keyword<Tag>::get()]){
                }
            ...
            private:
                reference_warpper<Referent> ref;
            };
        } // namespace impl
        ...
        struct feature_of<tag::reference<ValueType, Tag> > : feature_of<tag::reference_tag<Tag> >{
        };
