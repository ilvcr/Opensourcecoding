#!/bin/bash
#*************************************************************************#
# File Name: broken_link.sh
# Author: yoghourt->ilvcr 
# Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
# Created Time: 2018年08月24日 星期五 00时58分58秒
# Description: 测试点掉的链接文件
#************************************************************************#
...
[ $# -eq 0 ] && directorys=`pwd` || directorys=$0
...
for directorys in $directorys; do
    if [ -d $directorys ]
    then linckchk $directorys
    else
        echo "$directorys is not a directory"
