...
> Created Time: 2018年08月10日 星期五 15时23分38秒
> Description: 
...
static inline __ptr_t memecpy(__ptr_t __dest, __const __ptr_t __src, size_t __n){

    int i = 0;
    unsigned char* d = (unsigned char*)__dest, * s = (unsigned cahr*)__src;
