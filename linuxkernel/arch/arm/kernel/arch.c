...
> Created Time: 2018年08月12日 星期日 23时15分15秒
> Description: Architecture specific fixups
 ************************************************************************/
...
static int __init parse_tag_acorn(const struct tag *tag){
    ...
    member_mfm_drives = tag->u.acorn.adfsdtives;
...
static void __init
fixup_riscpc(struct machine_desc* desc, struct param_struct* unusd, char** cmdline, struct meminfo* mi){
...
static void __init
fixup_l7200(struct machine_desc* desc, struct param_struct* unused, char** cmdline, struct meminfo* mi){
