...
> Created Time: 2018年08月14日 星期二 23时29分42秒
> Description: 
...
static void arc_floppy_data_enable_dma(dmach_t channel, dma_t* dma){
    ...
    case DMA_MODE_READ:{ /* read */
        ...
        memcpy ((void *)0x1c, (void *)&fdc1772_dma_read, &fdc1772_dma_read_end - &fdc1772_dma_read);
    ...
    case DMA_MODE_WRITE: { /* write */
        ...
        memcpy ((void *)0x1c, (void *)&fdc1772_dma_write, &fdc1772_dma_write_end - &fdc1772_dma_write);
        fdc1772_setupdma(dma->buf.length, dma->buf.address); /* Sets data pointer up */
        enable_fiq(FIQ_FLOPPYDATA;
...
static void arc_floppy_cmdend_enable_dma(dmach_t channel, dma_t* dma){
    ...
    *((unsigned int*)0x1c) = 0xea000000 | (((unsigned int)fdc1772_comendhandler-(0x1c+8))/4);
...
static void a5k_floppy_enable_dma(dmach_t channel, dma_t* dma){
    ...
    extern void floppy_fiqsetup(unsigned long len, unsigned long addr, unsigned long port);
