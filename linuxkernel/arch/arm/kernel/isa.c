...
> Created Time: 2018年08月20日 星期一 19时54分40秒
> Description: ISA shared memory and I/O port support
 ************************************************************************/
...
void __init register_isa_ports(unsigned int membase, unsigned int portbase, unsigned int portshift){
