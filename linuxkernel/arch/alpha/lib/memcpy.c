...
> Created Time: 2018年08月05日 星期日 15时03分10秒
> Description: This is a reasonably optimized memcpy() routine.
 ************************************************************************/
 ...
 */
static inline voido __memcpy_unaligned_up(unsigned long d, unsigned long s, long n){
    ...
    if(n >= 0){
        ...
        do{
            ...
            __asm__("extql %1,%2,%0":"=r" (low_word):"r" (low_word), "r" (s));
            __asm__("extqh %1,%2,%0":"=r" (tmp):"r" (high_word), "r" (s));
...
static inline void __memcpy_unaligned_dn (unsigned long d, unsigned long s, long n){
...
static inline void __memcpy_aligned_dn (unsigned long d, unsigned long s, long n){
