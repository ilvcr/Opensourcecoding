...
> Created Time: 2018年08月01日 星期三 20时32分44秒
> Description: 
...
extern unsigned long switch_to_osf_pal(unsigned long nr,
        struct pcb_struct* pcd_va, struct pcb_struct* pcb_pa,
        unsigned long* vptb);
 ...
 */
#define VPRB  ((unsigned long*) 0x200000000)
...
void start_kernel(void){
...
#ifdef INITRD_IMAGE_SIZE
    /* The initrd must be page-aligned.  See below for the cause of the magic number 5.  */
    ...
    memeset((char*) ZERO_PGE, 0, PAGE_SIZE);
